...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды, Знач ДополнительныеПараметры) Экспорт
	...
	ОбщегоНазначения.КомандаСистемы(КомандаУстановитьРабочийКаталог);
	...
	ОбщегоНазначения.КомандаСистемы(КомандаУстановитьБазу);
	...
	ОбщегоНазначения.КомандаСистемы(КомандаСоздатьПоставку);
