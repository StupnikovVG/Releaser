...
Процедура ЗарегистрироватьКоманду(Знач ИмяКоманды, Знач Парсер) Экспорт
	...
	Парсер.ДобавитьПараметрФлагКоманды(ОписаниеКоманды, "--create_milestone", "Признак создания нового мэйлстоуна, к которому будут привязаны все задачи, выходящие в релизе");
...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды, Знач ДополнительныеПараметры) Экспорт
	...
	СоздатьМэйлСтоун = ПараметрыКоманды["--create_milestone"];
