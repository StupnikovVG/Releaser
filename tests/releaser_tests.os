...
Процедура Тест_ФормированиеРелиза() Экспорт
	...
	// ДистрибутивыДляОбновления.Добавить("./tests/Релизы/v1.1/1Cv8.cf");
	// УправлениеКонфигуратором.СоздатьФайлыПоставки("./tests/Релизы/v1.2/1Cv8.cf", 
	// 				"./tests/Релизы/v1.2/1Cv8.cfu", ДистрибутивыДляОбновления);
